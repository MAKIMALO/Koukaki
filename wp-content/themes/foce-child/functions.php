<?php
    ...
    function theme_enqueue_scripts() {
        ...
        wp_enqueue_script( 'burger-script', get_stylesheet_directory_uri() . '/js/burger.js', array(), '1.2', true );
        ...
        wp_enqueue_script( 'fadein-animation-script', get_stylesheet_directory_uri() . '/js/fadein_animation.js', array(), '1.2', true );
